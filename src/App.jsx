...
import {PutBox} from './component/Script.js'
import backgroundImage from './assets/Currency.jpg'
...
function App() {
  ...
  return (
    <div className='w-screen h-screen flex flex-wrap justify-center items-center bg-cover bg-center' 
         ...
         bg-white/30'>
          <form onSubmit={(e) => {
            ...
            <div className='relative w-full h-0.5'>
              ...
              rounded-md bg-blue-400 text-white px-2 py-0.5'
              onClick={swap}
              >Swap</button>
            </div>
